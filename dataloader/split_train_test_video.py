...
class UCF101_splitter():
    def __init__(self, path, split):
        self.path = "/home/hosseing/REPOS/two stream/two-stream-action-recognition/UCF_list/"
        self.split = split
    ...
    def split_video(self):
        ...
        print(f"#'==> (Training video, Validation video):(', {len(train_video)},{len(test_video)}")
...
if __name__ == '__main__':
    ...
    print(f"{len(train_video)} , {len(test_video)}")